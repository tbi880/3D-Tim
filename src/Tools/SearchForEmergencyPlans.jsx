    ...
    useEffect(() => {
        ...
        typedRef.current = new Typed(typingRef.current, {
            strings: [
                ...
                "Expanding query to classified files… File count: 423… Filtering to critical data only...",
                ...
                "Access granted. Loading document ‘Project Phoenix’—Status: Inactive.",
                "Parsing data structures...",
                "Cross-referencing with active ship systems...",
                "Identifying sub-protocols within ‘Project Phoenix’...",
                "Loading: ‘Energy Override’, ‘Warp Core Reboot’, ‘Quantum Shield Initiation’...",
