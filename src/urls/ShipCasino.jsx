...
function ShipCasino({ isPortraitPhoneScreen }) {
    ...
    return (
        <>
            ...
            {!showPlaceBets && <CasinoStatusForm roomName={roomName} roomId={roomId} moneyInRoom={moneyInRoom} />}
            {showCasinoForm && <CasinoRoomForm sceneSheet={casinoSheet} isPortraitPhoneScreen={isPortraitPhoneScreen} fetchRoomStatus={fetchRoomStatus} levelOfBets={levelOfBets} setLevelOfBets={setLevelOfBets} levels={levels} LevelMap={LevelMap} roomName={roomName} setRoomName={setRoomName} setRoomId={setRoomId} setCountdownMs={setCountdownMs} />}
            {showPlaceBets && (statusInRoom === "betting") && <PlaceBets isPortraitPhoneScreen={isPortraitPhoneScreen} moneyInRoom={moneyInRoom} roomId={roomId} fetchRoomStatus={fetchRoomStatus} levelOfBets={levelOfBets} LevelMap={LevelMap} setMainChoice={setMainChoice} mainBetValue={mainBetValue} setMainBetValue={setMainBetValue} sideOpen={sideOpen} setSideOpen={setSideOpen} smallTiger={smallTiger} setSmallTiger={setSmallTiger} bigTiger={bigTiger} setBigTiger={setBigTiger} tigerTie={tigerTie} setTigerTie={setTigerTie} chipSheet={chipSheet} setShowPlaceBets={setShowPlaceBets} setMoneyInRoom={setMoneyInRoom} />}
            <div style={{ position: 'relative', zIndex: 1, height: '100vh' }}>
                <CanvasProvider frameLoopSetting='demand'>
                    <Casino casinoSheet={casinoSheet} card2Sheet={card2Sheet} chipSheet={chipSheet} casinoProject={casinoProject} isPortraitPhoneScreen={isPortraitPhoneScreen} setShowPlaceBets={setShowPlaceBets} mainChoice={mainChoice} setMainChoice={setMainChoice} mainBetValue={mainBetValue} setMainBetValue={setMainBetValue} roomId={roomId} token={token} setStatusInRoom={setStatusInRoom} setCountdownMs={setCountdownMs} setBetSides={setBetSides} isOpeningFirstCard={isOpeningFirstCard} setIsOpeningFirstCard={setIsOpeningFirstCard} setShowSwitchCard={setShowSwitchCard} setResultList={setResultList} setWinningSides={setWinningSides} gameHands={gameHands} setGameHands={setGameHands} setBaccaratPointDisplayManager={setBaccaratPointDisplayManager} setPlayersData={setPlayersData} />
                </CanvasProvider>
